...
const Register = () => {
    ...
    const handleRegister = (e) => {
        e.preventDefault();
        if (!registerData.firstname.trim() || !registerData.lastname.trim() || !registerData.email.trim() || !registerData.password.trim()) {
            ...
            <div className="relative">
                ...
                <div className="bg-white p-8 flex flex-col justify-center md:absolute md:w-[25vw] md:h-[70vh] md:top-9 md:-left-40 md:rounded-xl rounded-t-xl shadow-2xl">
                    ...
                    <form onSubmit={handleRegister} className="mt-5">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#190634] hover:opacity-90 font-bold text-white py-2 rounded-lg mt-3"
                        >
                            SIGN UP
                        </button>
                    </form>
